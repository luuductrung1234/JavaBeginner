...
echo "Re-Create 'build-newest.sh' . . ."
rm "build-newest.sh"
echo "echo \"************************************************\"" >> "build-newest.sh"
echo "echo \"*                BUILD PROJECT                 *\"" >> "build-newest.sh"
echo "echo \"************************************************\"" >> "build-newest.sh"
echo "" >> "build-newest.sh"
echo "sh ./build/$fileName" >> "build-newest.sh"

echo "Append new build script to 'build.sh' . . ."
echo "" >> "build.sh"
